...
test.describe('Auth Module API Tests', () => {
  ...
  test('TC01: Đăng ký tài khoản thành công (Happy Path)', async ({ request }) => {
  ...
  test('TC02: Đăng ký thất bại khi email đã tồn tại (Duplicate Error)', async ({ request }) => {
  ...
  test('TC03: Đăng nhập thành công và nhận Access Token (Happy Path)', async ({ request }) => {
  ...
  test('TC04: Đăng nhập thất bại với sai mật khẩu (Unauthorized)', async ({ request }) => {
  ...
  test('TC05: Refresh Token cấp mới Access Token thành công', async ({ request }) => {
